...
SRC = ROOT / "project_current-1_中英文文献补充版.docx"
OUT = ROOT / "project_current-1_英文替换并按引用排序版.docx"


# 排序逻辑：按正文中首次出现的引用顺序排列。原第21、23、28、30条已替换。
REFERENCES = [
    ...
    "Pautasso C, Zimmermann O, Leymann F. RESTful web services vs. Big web services: making the right architectural decision[C]//Proceedings of the 17th International Conference on World Wide Web. 2008: 805-814.",
...
CITATION_REPLACEMENTS = {
    ...
    "[11-18][28-30]": "[8-18]",
    "[11-16][30]": "[8-13][18]",
    "[1-10][31-33]": "[1-7][19-26]",
    "[3-8][15]": "[3-4][12][19-22]",
    "[11-18][23-25]": "[8-15][27-29]",
    "[11-16]": "[8-13]",
    "[21-26]": "[27-32]",
    "[21-30][31-33]": "[5-7][16-18][30-33]",
}
